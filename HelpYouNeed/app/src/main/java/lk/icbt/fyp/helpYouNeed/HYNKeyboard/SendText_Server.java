...
public class SendText_Server extends AppCompatActivity {
    ...
    File fileToUpload = new File("/storage/emulated/0/FinKeyboard.txt");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_text__server);
    ...
    public void credentialsProvider(){
        ...
        CognitoCachingCredentialsProvider credentialsProvider = new CognitoCachingCredentialsProvider(
                ...
                "ap-south-1:93144c78-fb53-4c09-8ca8-22926f06e1d5", // Identity Pool ID
    ...
    public void setFileToUpload(View view){
        ...
        TransferObserver transferObserver = transferUtility.upload(
                "emotiondas",     /* The bucket to upload to *//*
               "FinKeyboard.txt",   /* The key for the uploaded object *//*
